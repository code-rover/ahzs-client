...
public class MogoGlobleLoadingUI : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        m_loadingImgBg = m_myTransform.FindChild("MogoGlobleLoadingBG").GetComponentsInChildren<UITexture>(true)[0];
        ...
        Transform goTemp = m_myTransform.FindChild("MogoGlobleLoadingStatusTip");
        if (goTemp != null)
        {
            m_lblLoadingStatusTip = goTemp.GetComponentsInChildren<UILabel>(true)[0];
        }
        m_spLoadingBar = m_myTransform.FindChild("MogoGlobleLoadingUIBottom/MogoGlobleLoadingUILoading/MogoGlobleLoadingUILoadingBar").GetComponentsInChildren<UISprite>(true)[0];
        m_spLoadingAnim = m_myTransform.FindChild("MogoGlobleLoadingUIBottom/MogoGlobleLoadingUILoading/MogoGlobleLoadingUILoadingAnim").GetComponentsInChildren<UISprite>(true)[0];

        Transform goTitle = m_myTransform.FindChild("MogoGlobleLoadingTitle");
        if (goTitle != null)
        {
            title = goTitle.GetComponentsInChildren<UILabel>(true)[0];
        }
        Transform goTip = m_myTransform.FindChild("MogoGlobleLoadingTip");
        if (goTip != null)
        {
