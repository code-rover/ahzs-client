...
public class GolemAnimation : GearParent
{
    ...
    public virtual void Starding()
    {
        if (standAnimation != null)
            gameObject.animation.CrossFade(standAnimation.name);
    }
    ...
    public virtual void Stood()
    {
        if (standAnimation != null)
        {
            ...
            animation[standAnimation.name].normalizedTime = 1f;
            gameObject.animation.CrossFade(standAnimation.name);
        }
    }
    ...
    public virtual void Hitting()
    {
        if (hitAnimation != null && triggleEnable)
            gameObject.animation.CrossFade(hitAnimation.name);
    }
    ...
    public virtual void Hit()
    {
        if (hitAnimation != null)
        {
            if (triggleEnable)
            {
                ...
                animation[hitAnimation.name].normalizedTime = 1f;
                gameObject.animation.CrossFade(hitAnimation.name);
            }
        }
    }
    ...
    public virtual void Dying()
    {
        if (deadAnimation != null && triggleEnable)
        {
            ...
            gameObject.animation.CrossFade(deadAnimation.name);
        }
    }
    ...
    public virtual void Dead()
    {
        if (deadAnimation != null)
        {
            //if (triggleEnable)
            {
                animation[deadAnimation.name].normalizedTime = 1f;
                gameObject.animation.CrossFade(deadAnimation.name);
            }
        }
    }
