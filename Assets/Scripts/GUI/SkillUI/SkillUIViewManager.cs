...
public class SkillUIViewManager : MogoUIBehaviour 
{
    ...
    public void ShowSkillCanLearnAnim(bool isShow, int id)
    {
        if (isShow)
        {
            if (MogoUIManager.Instance.m_MenuUI.transform.FindChild("PropSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].m_iCurrentId != 2 || MogoUIManager.Instance.CurrentUI != MogoUIManager.Instance.m_MenuUI)
                return;
    ...
    public void SetWeapon0PageText(string text)
    {
        ...
        {
            m_mtbWeapon0.transform.FindChild("SkillDialogPageWeapon0TestUp").GetComponentsInChildren<UILabel>(true)[0].text = text;
            m_mtbWeapon0.transform.FindChild("SkillDialogPageWeapon0TestDown").GetComponentsInChildren<UILabel>(true)[0].text = text;
        }
    ...
    public void SetWeapon1PageText(string text)
    {
        ...
        {
            m_mtbWeapon1.transform.FindChild("SkillDialogPageWeapon1TestUp").GetComponentsInChildren<UILabel>(true)[0].text = text;
            m_mtbWeapon1.transform.FindChild("SkillDialogPageWeapon1TestDown").GetComponentsInChildren<UILabel>(true)[0].text = text;
        }
    ...
    {
        m_myTransform.FindChild(m_widgetToFullName["SkillDialogPageList"]).GetComponent<MogoSingleButtonList>().SetCurrentDownButton(id);
