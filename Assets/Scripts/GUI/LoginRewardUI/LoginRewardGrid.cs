...
public class LoginRewardGrid : MonoBehaviour
{
        ...
        set
        {
            ...
            for (int i = 0; i < 6; ++i)
            {
                if (i < m_listLeftItem.Count)
                {
                    ...
                    InventoryManager.SetIcon(m_listLeftItem[i].Key, m_arrLeftItem[i].transform.FindChild("LoginRewardGridLeftItem" + i + "FG").GetComponentsInChildren<UISprite>(true)[0], m_listLeftItem[i].Value, m_arrLeftItem[i].transform.FindChild("LoginRewardGridLeftItem" + i + "Num").GetComponentsInChildren<UILabel>(true)[0], m_arrLeftItem[i].transform.FindChild("LoginRewardGridLeftItem" + i + "BG").GetComponentsInChildren<UISprite>(true)[0]);
        ...
        set
        {
            ...
            for (int i = 0; i < 2; ++i)
            {
                if (i < m_listRightItem.Count)
                {
                    ...
                    m_arrRightItem[i].transform.FindChild("LoginRewardGridLeftItem" + i + "FG").GetComponentsInChildren<UISprite>(true)[0].spriteName = m_listRightItem[i];
                }
                else
                {
        ...
        set
        {
            ...
            for (int i = 0; i < 6; ++i)
            {
                if (i < m_listLeftItemBG.Count)
                {
                    ...
                    m_arrLeftItem[i].transform.FindChild("LoginRewardGridLeftItem" + i + "BG").GetComponentsInChildren<UISprite>(true)[0].spriteName = m_listLeftItemBG[i];
                }
                else
                {
                    m_arrLeftItem[i].SetActive(false);
    ...
    void Awake()
    {
        ...
        m_lblNewServerRightText = m_myTransform.FindChild(
        ...
        m_lblOldServerRightText = m_myTransform.FindChild(
        ...
        m_goLoginRewardGridLeftBG = m_myTransform.FindChild("LoginRewardGridLeft/LoginRewardGridLeftBGGO").gameObject;
        m_spLeftGetSign = m_myTransform.FindChild("LoginRewardGridLeft/LoginRewardGridLeftGetSign").GetComponentsInChildren<UISprite>(true)[0];
        m_spRightGetSign = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightNewServer/LoginRewardGridRightGetSign").GetComponentsInChildren<UISprite>(true)[0];
        m_lblOldServerItemName = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightOldServer/LoginRewardGridRightOldServerItemName").GetComponentsInChildren<UILabel>(true)[0];
        m_lblOldServerItemNum = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightOldServer/LoginRewardGridRightOldServerItemNum").GetComponentsInChildren<UILabel>(true)[0];
        m_lblOldServerItemCD = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightOldServer/LoginRewardGridRightOldServerItemCD").GetComponentsInChildren<UILabel>(true)[0];
        m_lblOldServerCostText = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightOldServer/LoginRewardGridRightOldServerItemCostNum").GetComponentsInChildren<UILabel>(true)[0];
        m_spOldServerCostSign = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightOldServer/LoginRewardGridRightOldServerCostImg").GetComponentsInChildren<UISprite>(true)[0];
        m_spOldServerItemFG = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightOldServer/LoginRewardGridRightOldServerItemFG").GetComponentsInChildren<UISprite>(true)[0];
        //m_spOldServerItemFG.selfRefresh = false;
        m_spOldServerItemBG = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightOldServer/LoginRewardGridRightOldServerItemBG").GetComponentsInChildren<UISprite>(true)[0];
        m_tsOldServerBuySign = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightOldServer/LoginRewardGridRightOldServerBuySign").GetComponentsInChildren<TweenScale>(true)[0];
        ...
        m_trans1Pos = m_myTransform.FindChild("LoginRewardGridLeft/LoginRewardGridLeftItemList1Pos");
        m_trans2Pos = m_myTransform.FindChild("LoginRewardGridLeft/LoginRewardGridLeftItemList2Pos");
        m_trans3Pos = m_myTransform.FindChild("LoginRewardGridLeft/LoginRewardGridLeftItemList3Pos");
        m_trans4Pos = m_myTransform.FindChild("LoginRewardGridLeft/LoginRewardGridLeftItemList4Pos");

        m_goLeftItemList = m_myTransform.FindChild("LoginRewardGridLeft/LoginRewardGridLeftItemList").gameObject;
        m_goRightItemList = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightNewServer/LoginRewardGridRightNewServerItemList").gameObject;

        m_goOldServerPart = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightOldServer").gameObject;
        m_goNewServerPart = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightNewServer").gameObject;

        m_mbBuy = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightOldServer/LoginRewardGridRightOldServerBuyBtn").GetComponentsInChildren<MogoButton>(true)[0];
        m_mbGet = m_myTransform.FindChild("LoginRewardGridLeft/LoginRewardGridLeftGetBtn").GetComponentsInChildren<MogoButton>(true)[0];
        ...
        for (int i = 0; i < 6; ++i)
        {
            m_arrLeftItem[i] = m_myTransform.FindChild("LoginRewardGridLeft/LoginRewardGridLeftItemList/LoginRewardGridLeftItem" + i).gameObject;
            m_arrrLeftItemNum[i] = m_myTransform.FindChild("LoginRewardGridLeft/LoginRewardGridLeftItemList/LoginRewardGridLeftItem" + i
                + "/LoginRewardGridLeftItem" + i + "Num").GetComponentsInChildren<UILabel>(true)[0];
            m_arrLeftItemGetSigin[i] = m_myTransform.FindChild("LoginRewardGridLeft/LoginRewardGridLeftItemList/LoginRewardGridLeftItem" + i
                + "/LoginRewardGridLeftItem" + i + "GetSign").gameObject;
            m_arrLeftItemImg[i] = m_arrLeftItem[i].transform.FindChild("LoginRewardGridLeftItem" + i + "FG").GetComponentsInChildren<UISprite>(true)[0];
        ...
        for (int i = 0; i < 2; ++i)
        {
            m_arrRightItem[i] = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightNewServer/LoginRewardGridRightNewServerItemList/LoginRewardGridLeftItem" + i).gameObject;
        }

        m_oldServerItemFGImgGrid = m_myTransform.FindChild("LoginRewardGridRight/LoginRewardGridRightOldServer/LoginRewardGridRightOldServerItemBG").gameObject.AddComponent<InventoryGrid>(); ;
    }
