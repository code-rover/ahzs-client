...
public class ChallengeUIGrid : MonoBehaviour
{
    ...
    void Awake()
    {
        challengeName = transform.FindChild("GOChallengeGridTitle/ChallengeGridName").GetComponent<UILabel>();
        challengeMessage = transform.FindChild("ChallengeGridMessage").GetComponent<UILabel>();
        challengeMessage.color = SystemUIColorManager.BROWN;
        challengeImg = transform.FindChild("ChallengeGridImage").GetComponent<UISprite>();
        m_goChallengeGridActiveFX = transform.FindChild("ChallengeGridActiveFX").gameObject;
        m_goFlashSurface = transform.FindChild("ChallengeGridFlashSurface").gameObject;
    }
