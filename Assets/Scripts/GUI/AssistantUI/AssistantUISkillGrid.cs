...
public class AssistantUISkillGrid : MonoBehaviour
{
    ...
    void Awake()
    {
        m_spIconFG = transform.FindChild("AssistantUIGridIcon").GetComponentsInChildren<UISprite>(true)[0];
        m_spIconLock = transform.FindChild("AssistantUIGridUnLock").GetComponentsInChildren<UISprite>(true)[0];
