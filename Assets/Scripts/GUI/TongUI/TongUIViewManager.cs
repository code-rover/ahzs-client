    ...
    public void ShowMyTongMemberList()
    {
        ...
        AddList(m_myTongMemberListButtonList,
            ...
            (index, go) =>
            {
                ...
                go.transform.FindChild("MyTongMemberListGridVocation").GetComponent<UISprite>().spriteName = m_myTongMemberDataList[index].vocationIcon;
                go.transform.FindChild("MyTongMemberListGridName").GetComponent<UILabel>().text = m_myTongMemberDataList[index].name;

                go.transform.FindChild("MyTongMemberListGridLevel").GetComponent<UILabel>().text = m_myTongMemberDataList[index].level;

                go.transform.FindChild("MyTongMemberListGridPosition").GetComponent<UILabel>().text = m_myTongMemberDataList[index].position;

                go.transform.FindChild("MyTongMemberListGridContribution").GetComponent<UILabel>().text = m_myTongMemberDataList[index].contribution;

                go.transform.FindChild("MyTongMemberListGridPower").GetComponent<UILabel>().text = m_myTongMemberDataList[index].power;

                go.transform.FindChild("MyTongMemberListGridDate").GetComponent<UILabel>().text = m_myTongMemberDataList[index].date;
    ...
    public void ShowMyTongApplicantList()
    {
        ...
        AddList(null,
            ...
            (index, go) =>
            {
                ...
                go.transform.FindChild("MyTongApplicantListGridBtnOk").gameObject.AddComponent<TongButton>().id = index;
                go.transform.FindChild("MyTongApplicantListGridBtnCancel").gameObject.AddComponent<TongButton>().id = index;

                go.transform.FindChild("MyTongApplicantListGridVocation").GetComponent<UISprite>().spriteName = m_myTongApplicantDataList[index].vocationIcon;
                go.transform.FindChild("MyTongApplicantListGridName").GetComponent<UILabel>().text = m_myTongApplicantDataList[index].name;

                go.transform.FindChild("MyTongApplicantListGridLevel").GetComponent<UILabel>().text = m_myTongApplicantDataList[index].level;

                go.transform.FindChild("MyTongApplicantListGridPower").GetComponent<UILabel>().text = m_myTongApplicantDataList[index].power;
    ...
    public void ShowMyTongPresenterList()
    {
        ...
        AddList(m_myTongPresenterListButtonList,
            ...
            (index, go) =>
            {
                ...
                go.transform.FindChild("MyTongPresenterListGridVocation").GetComponent<UISprite>().spriteName = m_myTongPresenterDataList[index].vocationIcon;
                go.transform.FindChild("MyTongPresenterListGridName").GetComponent<UILabel>().text = m_myTongPresenterDataList[index].name;

                go.transform.FindChild("MyTongPresenterListGridLevel").GetComponent<UILabel>().text = m_myTongPresenterDataList[index].level;

                go.transform.FindChild("MyTongPresenterListGridPower").GetComponent<UILabel>().text = m_myTongPresenterDataList[index].power;
    ...
    public void ShowSkillList()
    {
        ...
        AddList(null,
            ...
            (index, go) =>
            {
                ...
                go.transform.FindChild("MyTongSkillListGridUpgradeBtn").gameObject.AddComponent<TongButton>().id = index;

                go.transform.FindChild("MyTongSkillListGridIcon").GetComponent<UISprite>().spriteName = m_myTongSkillDataList[index].icon;
                go.transform.FindChild("MyTongSkillListGridBanner").FindChild("MyTongSkillListGridBannerText").GetComponent<UILabel>().text = m_myTongSkillDataList[index].name;

                go.transform.FindChild("MyTongSkillListGridStarList").GetComponent<UIStarList>().SetStarNum(m_myTongSkillDataList[index].starNum);

                Transform reward = go.transform.FindChild("MyTongSkillListGridReward");
                Transform reward1 = reward.FindChild("MyTongSkillListGridReward1");
                Transform reward2 = reward.FindChild("MyTongSkillListGridReward2");
                reward1.FindChild("MyTongSkillListGridReward1Lbl").GetComponent<UILabel>().text = m_myTongSkillDataList[index].effect1;
                reward2.FindChild("MyTongSkillListGridReward2Lbl").GetComponent<UILabel>().text = m_myTongSkillDataList[index].effect2;
