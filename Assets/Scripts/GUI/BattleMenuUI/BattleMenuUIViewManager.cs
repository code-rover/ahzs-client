...
public class BattleMenuUIViewManager : MonoBehaviour 
{
    ...
    void Awake()
    {
        ...
        m_myTransform.FindChild("TopRightBattleMenuUI").GetComponentsInChildren<UIAnchor>(true)[0].uiCamera = GameObject.Find("Camera").GetComponentsInChildren<Camera>(true)[0];
