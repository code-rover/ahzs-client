...
public class SpriteUIViewManager : MogoUIBehaviour
{
    ...
    {
        m_goSpriteUILearnSkillUIDetailSkill.transform.FindChild("SpriteUILearnSkillUIDetailSkillIcon").GetComponentsInChildren<UISprite>(true)[0].spriteName = spriteName;
        m_goSpriteUILearnSkillUIDetailSkill.transform.FindChild("SpriteUILearnSkillUIDetailSkillName").GetComponentsInChildren<UILabel>(true)[0].text = name;
        m_goSpriteUILearnSkillUIDetailSkill.transform.FindChild("SpriteUILearnSkillUIDetailSkillLevel").GetComponentsInChildren<UILabel>(true)[0].text = string.Concat("LV", level);
    }
        ...
        {           
            ...
            AssetCacheMgr.GetUIInstance("SpriteUIProgressLine.prefab",
                (str, id, obj) =>
                {
                    ...
                    m_maplistProgressLine[index] = goProgressLine.transform.FindChild("SpriteUIProgressLineFG").GetComponentsInChildren<UISprite>(true)[0];
    ...
    public void LoadSpriteUIScene(Action action = null)
    {
        if (!IsSpriteUISceneLoaded)
        {
            ...
            AssetCacheMgr.GetInstance(SPRITEUI_SCENE_NAME, (prefab, guid, go) =>
            {
                ...
                SpriteSceneCamera = obj.transform.FindChild("elf/Main Camera").GetComponentsInChildren<Camera>(true)[0];
    ...
    {
        m_goSpriteSceneModelPos = m_goSpriteUIScene.transform.FindChild("elf_icon/SpriteSkillCenterPos").gameObject;
    ...
    private void GetSpriteSkillByName()
    {
        ...
        m_maplistSpriteSkill[0] = m_goSpriteUIScene.transform.FindChild("elf_icon/" + SpriteSkill1Name).gameObject;
        m_maplistSpriteSkill[1] = m_goSpriteUIScene.transform.FindChild("elf_icon/" + SpriteSkill2Name).gameObject;
        m_maplistSpriteSkill[2] = m_goSpriteUIScene.transform.FindChild("elf_icon/" + SpriteSkill3Name).gameObject;
        m_maplistSpriteSkill[3] = m_goSpriteUIScene.transform.FindChild("elf_icon/" + SpriteSkill4Name).gameObject;
        m_maplistSpriteSkill[4] = m_goSpriteUIScene.transform.FindChild("elf_icon/" + SpriteSkill5Name).gameObject;
            ...
            if (m_maplistSpriteSkill.ContainsKey(i))
            {
                ...
                AssetCacheMgr.GetUIInstance(string.Concat(skillFxName, ".prefab"),
                    (str, id, obj) =>
                    {
                        ...
                        goSkillFx.transform.parent = m_maplistSpriteSkill[index].transform.FindChild("bone_Plane001/Bone001");
