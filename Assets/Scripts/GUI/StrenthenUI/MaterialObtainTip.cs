...
public class MaterialObtainTip : MogoUIBehaviour 
{
    ...
    public void LoadResourceInsteadOfAwake()
    {
        ...
        m_goMaterialObtainTipMat1Pos = m_myTransform.FindChild(m_widgetToFullName["MaterialObtainTipMat1Pos"]).gameObject;
        m_goMaterialObtainTipMat2Pos = m_myTransform.FindChild(m_widgetToFullName["MaterialObtainTipMat2Pos"]).gameObject;
        m_goGOMaterialObtainNormalCrystal = m_myTransform.FindChild(m_widgetToFullName["GOMaterialObtainNormalCrystal"]).gameObject;
        m_goGOMaterialObtainPerfectCrystal = m_myTransform.FindChild(m_widgetToFullName["GOMaterialObtainPerfectCrystal"]).gameObject;
        m_goMaterialObtainTipBGLine = m_myTransform.FindChild(m_widgetToFullName["MaterialObtainTipBGLine"]).gameObject;
