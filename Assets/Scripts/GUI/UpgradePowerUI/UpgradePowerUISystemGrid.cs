...
public class UpgradePowerUISystemGrid : MogoUIBehaviour 
{
    ...
    void Awake()
    {
        ...
        m_goGOUpgradePowerUIScore = m_myTransform.FindChild(m_widgetToFullName["GOUpgradePowerUIScore"]).gameObject;
        m_spProgressFG = m_myTransform.FindChild(m_widgetToFullName["ProgressFG"]).GetComponentsInChildren<UISprite>(true)[0];
        m_goGOStar = m_myTransform.FindChild(m_widgetToFullName["GOStar"]).gameObject;
        m_listStar.Add(m_myTransform.FindChild(m_widgetToFullName["Star1"]).gameObject);
        m_listStar.Add(m_myTransform.FindChild(m_widgetToFullName["Star2"]).gameObject);
        m_listStar.Add(m_myTransform.FindChild(m_widgetToFullName["Star3"]).gameObject);
        m_spSystemIconFG = m_myTransform.FindChild(m_widgetToFullName["SystemIconFG"]).GetComponentsInChildren<UISprite>(true)[0];
        m_lblSystemIconText = m_myTransform.FindChild(m_widgetToFullName["SystemIconText"]).GetComponentsInChildren<UILabel>(true)[0];
        m_goUpgradePowerUISystemGridTip = m_myTransform.FindChild(m_widgetToFullName["UpgradePowerUISystemGridTip"]).gameObject;
        m_goGOUpgradePowerUINoOpen = m_myTransform.FindChild(m_widgetToFullName["GOUpgradePowerUINoOpen"]).gameObject;
        m_lblUpgradePowerUINoOpenText = m_myTransform.FindChild(m_widgetToFullName["UpgradePowerUINoOpenText"]).GetComponentsInChildren<UILabel>(true)[0];
    }
