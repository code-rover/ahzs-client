...
public class DebugUIViewManager : MonoBehaviour 
{
    ...
    void Awake()
    {
        ...
        m_lblPosInfo = transform.FindChild("DebugUIPos").GetComponentsInChildren<UILabel>(true)[0];
        m_lblFPS = transform.FindChild("DebugUIFPS").GetComponentsInChildren<UILabel>(true)[0];
    }
