...
public class AttributeRewardGrid : MonoBehaviour 
{
    ...
    void Awake()
    {
        ...
        m_spSignFG = m_myTransform.FindChild("AttributeRewardGridSignFG").GetComponentsInChildren<UISprite>(true)[0];
        m_lblSignText = m_myTransform.FindChild("AttributeRewardGridSignText").GetComponentsInChildren<UILabel>(true)[0];
        m_lblTitle = m_myTransform.FindChild("AttributeRewardGridTitle").GetComponentsInChildren<UILabel>(true)[0];
        m_lblQuest = m_myTransform.FindChild("AttributeRewardGridQuest").GetComponentsInChildren<UILabel>(true)[0];
        m_spProcessFG = m_myTransform.FindChild("AttributeRewardGridProcessFG").GetComponentsInChildren<UISprite>(true)[0];
        m_spFinishedSign = m_myTransform.FindChild("AttributeRewardFinishedSign").GetComponentsInChildren<UISprite>(true)[0];
        m_lblProcessText = m_myTransform.FindChild("AttributeRewardGridProcessText").GetComponentsInChildren<UILabel>(true)[0];
        m_goShareBtn = m_myTransform.FindChild("AttributeRewardShareBtn").gameObject;
        m_goRunningSign = m_myTransform.FindChild("AttributeRewardGridRunningText").gameObject;
