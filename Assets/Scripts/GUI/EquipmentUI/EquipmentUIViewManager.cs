...
public class EquipmentUIViewManager : MogoUIBehaviour
{
    ...
    private UISprite m_spEquipmentUIMogoUIRefreshCtrl; // 用于刷新MogoUI图集
    ...
    void Initialize()
    {
        m_myTransform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet/EquipmentUIIconList/InsetIcon").GetComponentsInChildren<MogoButton>(true)[0].clickHandler += OnInsetIconUp;
        m_myTransform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet/EquipmentUIIconList/DecomposeIcon").GetComponentsInChildren<MogoButton>(true)[0].clickHandler += OnDecomposeIconUp;
        m_myTransform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet/EquipmentUIIconList/ComposeIcon").GetComponentsInChildren<MogoButton>(true)[0].clickHandler += OnComposeIconUp;
        m_myTransform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet/EquipmentUIIconList/StrenthenIcon").GetComponentsInChildren<MogoButton>(true)[0].clickHandler += OnStrenthIconUp;
        m_myTransform.FindChild("EquipmentUIClose").GetComponentsInChildren<MogoButton>(true)[0].clickHandler += OnEquipmentUICloseUp;
