...
public class EquipFXUIGrid : MonoBehaviour 
{
    ...
    void Awake()
    {
        ...
        m_spIconFG = m_myTransform.FindChild("EquipFXUIDialogFXGridIconFG").GetComponentsInChildren<UISprite>(true)[0];
        m_lblTextNotGet = m_myTransform.FindChild("EquipFXUIDialogFXGridNotGetText").GetComponentsInChildren<UILabel>(true)[0];
        m_lblTextGot = m_myTransform.FindChild("EquipFXUIDialogFXGridGotText").GetComponentsInChildren<UILabel>(true)[0];
        m_lblProgress = m_myTransform.FindChild("EquipFXUIDialogFXGridProcess/EquipFXUIDialogFXGridProcessText").GetComponentsInChildren<UILabel>(true)[0];
        m_spProgressFG = m_myTransform.FindChild("EquipFXUIDialogFXGridProcess/EquipFXUIDialogFXGridProcessFG").GetComponentsInChildren<UISprite>(true)[0];
        m_lblActiveBtnText = m_myTransform.FindChild("EquipFXUIDialogFXGridActiveBtn/EquipFXUIDialogFXGridActiveBtnText").GetComponentsInChildren<UILabel>(true)[0];

        m_goProgress = m_myTransform.FindChild("EquipFXUIDialogFXGridProcess").gameObject;
        m_goActiveBtn = m_myTransform.FindChild("EquipFXUIDialogFXGridActiveBtn").gameObject;
        m_spGetSign = m_myTransform.FindChild("EquipFXUIDialogFXGridGetSign").GetComponentsInChildren<UISprite>(true)[0];
    ...
    {
        m_myTransform.FindChild("EquipFXUIDialogFXGridActiveBtn").GetComponentsInChildren<MFUIButtonHandler>(true)[0].ID = this.ID;
        m_myTransform.FindChild("EquipFXUIDialogFXGridActiveBtn").GetComponentsInChildren<MFUIButtonHandler>(true)[0].ClickHandler = act;
    }
