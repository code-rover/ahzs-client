...
public class ChooseCharacterUIGrid : MonoBehaviour 
{
    ...
    void Awake()
    {
        ...
        m_lblName = m_myTransform.FindChild("ChooseCharcterUIGridEnable/ChooseCharcterUIGridName").GetComponentsInChildren<UILabel>(true)[0];
        m_lblDefaultText = m_myTransform.FindChild("ChooseCharcterUIGridDisable/ChooseCharcterUIGridDefaultText").GetComponentsInChildren<UILabel>(true)[0];
        m_lblLevel = m_myTransform.FindChild("ChooseCharcterUIGridEnable/ChooseCharcterUIGridLevel").GetComponentsInChildren<UILabel>(true)[0];
        m_spDefaultImg = m_myTransform.FindChild("ChooseCharcterUIGridDisable/ChooseCharcterUIGridDefaultImg").GetComponentsInChildren<UISprite>(true)[0];
        m_spHeadImg = m_myTransform.FindChild("ChooseCharcterUIGridEnable/ChooseCharcterUIGriHeadImg").GetComponentsInChildren<UISprite>(true)[0];

        m_goEnablePart = m_myTransform.FindChild("ChooseCharcterUIGridEnable").gameObject;
        m_goDisablePart = m_myTransform.FindChild("ChooseCharcterUIGridDisable").gameObject;
    }
