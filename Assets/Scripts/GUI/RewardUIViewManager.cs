    ...
    public void AddIconList(List<RewardUIIconData> list)
    {
        for(int i = 0;i < list.Count;++i)
        {
            ...
            AssetCacheMgr.GetUIInstance("RewardUIIcon.prefab",(name,id,obj)=>
            {
                ...
                iconGo.transform.FindChild("RewardUIIconText").GetComponentsInChildren<UILabel>(true)[0].text = list[index].iconText;
                iconGo.transform.FindChild("RewardUIIconTextFG").GetComponentsInChildren<UILabel>(true)[0].text = list[index].iconText;
                ...
                if (index == 0)
                {
                    m_listIcon[0].transform.FindChild("RewardUIIconBGDown").gameObject.SetActive(true);
                    m_listIcon[0].transform.FindChild("RewardUIIconText").gameObject.SetActive(false);
                    m_listIcon[0].transform.FindChild("RewardUIIconTextFG").gameObject.SetActive(true);
                }
            });
        }
