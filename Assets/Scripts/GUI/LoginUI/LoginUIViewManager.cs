...
public class LoginUIViewManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        m_texLogoBG = m_myTransform.FindChild(m_widgetToFullName["LoginUILogoBG"]).GetComponentsInChildren<UITexture>(true)[0];
        m_texLogoFG = m_myTransform.FindChild(m_widgetToFullName["LoginUILogoFG"]).GetComponentsInChildren<UITexture>(true)[0];
