...
public class MogoUIManager : MonoBehaviour
{
    ...
    public readonly static bool IsShowLevel = false; // 玩家头顶和聊天是否显示等级
    public readonly static bool ISTONGUIOPENED = false; // 是否开启公会
    ...
    public GameObject m_InstanceMissionChooseUI { get; protected set; } // 可拖动副本选择界面
    ...
    public GameObject m_RankingUI; // 排行榜界面
    public GameObject m_RankingRewardUI; // 排行榜奖励
    GameObject m_UpgradePowerUI; // 战力提升指引界面
    GameObject m_EquipRecommendUI; // 装备推荐界面
    GameObject m_InstanceBossTreasureUI; // 副本BOSS宝箱界面
    public GameObject m_LevelNoEnoughUI; // 等级不足引导界面
    public GameObject m_EnergyNoEnoughUI; // 体力不足引导界面
    public GameObject m_DragonMatchUI; // 飞龙大赛界面
    public GameObject m_DragonMatchRecordUI; // 飞龙大赛记录界面
    public GameObject m_ChooseDragonUI; // 选择飞龙界面
    public GameObject m_OKCancelTipUI; // 确认框-可以选择不再提示  
    public GameObject m_SpriteUI; // 精灵系统
    public GameObject m_OccupyTowerPassUI; // 占塔结算界面
    public GameObject m_OccupyTowerUI; // 占塔界面
    public GameObject m_NewArenaUI; // 新竞技场界面
    ...
    public void ShowUI(bool IsShow)
    {
        if (!UICanChange)
            return;
        //m_CurrentUI.SetActive(IsShow);
        GameObject.Find("MogoMainUI").transform.FindChild("Camera").GetComponentsInChildren<Camera>(true)[0].enabled = IsShow;
        GameObject.Find("MogoMainUI").transform.FindChild("Camera").GetComponentsInChildren<UICamera>(true)[0].enabled = IsShow;
    ...
    public void ShowSubtitle(string text, float fontSize, float time)
    {
        ...
        m_mainUICamera = GameObject.Find("MogoMainUI").transform.FindChild("Camera").GetComponent<Camera>();
    ...
    public void SwitchSkillsContractUI()
    {
        ...
        m_AssistantUI.transform.FindChild("TopRight/AssistantUIDialogList").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(0);
    }
    ...
    public void SwitchElementHintmarkUI()
    {
        ...
        m_AssistantUI.transform.FindChild("TopRight/AssistantUIDialogList").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(1);
    }
                ...
                PreLoadResource("StrenthenDialogIconGrid.prefab", (obj) =>
                {
                    AssetCacheMgr.GetUIInstance("StrenthUI.prefab",
                        (prefab, guid, go) =>
                        {
                            ...
                            m_StrenthUI.transform.parent = m_EquipmentUI.transform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet/EquipmentUIDialogList/StrenthenDialog").transform;
                            ...
                            m_EquipmentUI.transform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(0);
                ...
                PreLoadResources(resName, (obj) =>
                {
                    AssetCacheMgr.GetUIInstance("InsetUI.prefab",
                        (prefab, guid, go) =>
                        {
                            ...
                            m_InsetUI.transform.parent = m_EquipmentUI.transform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet/EquipmentUIDialogList/InsetDialog").transform;
                            ...
                            m_EquipmentUI.transform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(1);
            ...
            PreLoadResources(resName, (obj) =>
            {
                AssetCacheMgr.GetUIInstance("ComposeUI.prefab",
                    (prefab, guid, go) =>
                    {
                        ...
                        m_ComposeUI.transform.parent = m_EquipmentUI.transform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet/EquipmentUIDialogList/ComposeDialog").transform;
                        ...
                        m_EquipmentUI.transform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(2);
            ...
            PreLoadResources(resName, (obj) =>
            {
                AssetCacheMgr.GetUIInstance("DecomposeUI.prefab",
                    (prefab, guid, go) =>
                    {
                        ...
                        m_DecomposeUI.transform.parent = m_EquipmentUI.transform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet/EquipmentUIDialogList/DecomposeDialog").transform;
                        ...
                        m_EquipmentUI.transform.FindChild("EquipmentUIDialogList/EquipmentUIDialogListSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(3);
    ...
    public void SwitchPackageUI()
    {
        ...
        if (m_MenuUI != CurrentUI)
            ShowMogoMenuUI();
        m_MenuUI.transform.FindChild("PropSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(1);
    ...
    public void SwitchPlayerUI()
    {
        ...
        if (m_MenuUI != CurrentUI)
            ShowMogoMenuUI();
        m_MenuUI.transform.FindChild("PropSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(0);
    }
            ...
            ShowMogoMenuUI(() =>
            {
                if (m_SkillUI == null)
                {
                  ...
                  (prefab, guid, go) =>
                  {
                      ...
                      m_SkillUI.transform.parent = m_MenuUI.transform.FindChild("PropSheet/DialogList/SkillDialog").transform;
                      ...
                      m_MenuUI.transform.FindChild("PropSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(2);
    ...
    public void SwitchTongUI()
    {
        ...
        if (m_MenuUI != CurrentUI)
            ShowMogoMenuUI();
        m_MenuUI.transform.FindChild("PropSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(3);

        Transform tranTongNoOpen = m_MenuUI.transform.FindChild("PropSheet/DialogList/TongDialog/GOTongNoOpen");
        if (!ISTONGUIOPENED)
        {
            ...
            if (!isTongUILoaded)
            {
                ...
                AssetCacheMgr.GetUIInstance("TongUI.prefab",
                    (prefab, guid, go) =>
                    {
                        ...
                        Utils.MountToSomeObjWithoutPosChange(m_TongUI.transform, m_MenuUI.transform.FindChild("PropSheet/DialogList/TongDialog").transform);
                ...
                PreLoadResources(resName, (obj) =>
                {
                    ...
                    AssetCacheMgr.GetUIInstance("SocietyUI.prefab",
                        (prefab, guid, go) =>
                        {
                            ...
                            m_SocietyUI.transform.parent = m_MenuUI.transform.FindChild("PropSheet/DialogList/SocialDialog").transform;
                            ...
                            m_MenuUI.transform.FindChild("PropSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(4);
            ...
            if (!IsSettingsUILoaded)
            {
                ...
                AssetCacheMgr.GetUIInstance("SettingsUI.prefab",
                    (prefab, guid, go) =>
                    {
                        ...
                        m_SettingUI.transform.parent = m_MenuUI.transform.FindChild("PropSheet/DialogList/SettingsDialog").transform;
                        ...
                        m_MenuUI.transform.FindChild("PropSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(5);
                        MogoGlobleUIManager.Instance.ShowWaitingTip(false);
                    }
                );
            }
    ...
    public void SwitchWorldChannelUI()
    {
        ...
        m_CommunityUI.transform.FindChild("CommunityUIBottom/CommunityUIDialogSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(0);
    ...
    public void SwitchTongChannelUI()
    {
        ...
        m_CommunityUI.transform.FindChild("CommunityUIBottom/CommunityUIDialogSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(1);
        CommunityUIViewManager.Instance.ShowFriendButton(false);
    }
    ...
    public void SwitchPrivateChannelUI()
    {
        ...
        m_CommunityUI.transform.FindChild("CommunityUIBottom/CommunityUIDialogSheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(2);
            ...
            if (!IsChargeRewardUILoaded)
            {
                ...
                AssetCacheMgr.GetUIInstance("ChargeRewardUI.prefab",
                    (prefab, guid, go) =>
                    {
                        ...
                        m_ChargeRewardUI.transform.parent = m_OperatingUI.transform.FindChild("OperatingUISheet/OperatingUIDialogList/ChargeRewardDialog").transform;
                        ...
                        m_OperatingUI.transform.FindChild("OperatingUISheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(0);
                ...
                PreLoadResource("TimeLimitActivityGrid.prefab", (obj) =>
                {
                    AssetCacheMgr.GetUIInstance("TimeLimitActivityUI.prefab",
                        (prefab, guid, go) =>
                        {
                            ...
                            m_TimeLimitActivityUI.transform.parent = m_OperatingUI.transform.FindChild("OperatingUISheet/OperatingUIDialogList/TimeLimitActivityDialog").transform;
                ...
                PreLoadResource("LoginRewardGrid.prefab", (obj) =>
                {
                    AssetCacheMgr.GetUIInstance("LoginRewardUI.prefab",
                        (prefab, guid, go) =>
                        {
                            ...
                            m_LoginRewardUI.transform.parent = m_OperatingUI.transform.FindChild("OperatingUISheet/OperatingUIDialogList/LoginRewardDialog").transform;
                            ...
                            m_OperatingUI.transform.FindChild("OperatingUISheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(2);
                ...
                PreLoadResource("AttributeRewardGrid.prefab", (obj) =>
                {
                    AssetCacheMgr.GetUIInstance("AttributeRewardUI.prefab",
                        (prefab, guid, go) =>
                        {
                            ...
                            m_AttributeRewardUI.transform.parent = m_OperatingUI.transform.FindChild("OperatingUISheet/OperatingUIDialogList/AttributeRewardDialog").transform;
                            ...
                            m_OperatingUI.transform.FindChild("OperatingUISheet").GetComponentsInChildren<MogoPropSheet>(true)[0].SwitchDialog(3);
    ...
    void Awake()
    {
        ...
        m_NormalMainUI = m_myTransform.FindChild("NormalMainUI").gameObject;
        m_DebugUI = m_myTransform.FindChild("DebugUI").gameObject;
    ...
    public Camera GetMessageBoxCamera()
    {
        ...
        {
            m_msgBoxCamera = GameObject.Find("MogoMainUI").transform.FindChild("MessageBoxCamera").GetComponent<Camera>();
        }
    ...
    public Camera GetUIFXCamera()
    {
        ...
        {
            m_uiFXCamera = GameObject.Find("MogoMainUI").transform.FindChild("UIFXCamera").GetComponent<Camera>();
        }
    ...
    public Camera GetSwitchUICamera()
    {
        ...
        {
            m_switchUICamera = GameObject.Find("MogoMainUI").transform.FindChild("SwitchUICamera").GetComponent<Camera>();
        }
