...
public class TaskUIViewManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        m_lblTaskUINPCDialogText = m_myTransform.FindChild("TaskUIBottom/TaskUIDialogContext/TaskUINPCDialogText").GetComponentsInChildren<UILabel>(true)[0];
        m_lblTaskUINPCName = m_myTransform.FindChild("TaskUIBottom/TaskUIDialogContext/TaskUINPCName").GetComponentsInChildren<UILabel>(true)[0];
        m_myTransform.FindChild("TaskUIBottom").GetComponentsInChildren<UIAnchor>(true)[0].uiCamera = GameObject.Find("MogoMainUI").transform.FindChild("Camera").GetComponentsInChildren<Camera>(true)[0];

        m_texTaskUINPCImage = m_myTransform.FindChild("TaskUIBottom/TaskUINPCImage").GetComponentsInChildren<UITexture>(true)[0];

        m_goContext = m_myTransform.FindChild("TaskUIBottom/TaskUIDialogContext").gameObject;
