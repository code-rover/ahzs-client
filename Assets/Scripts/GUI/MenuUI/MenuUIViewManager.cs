...
public class MenuUIViewManager : MogoUIBehaviour
{
    ...
    {
        m_myTransform.FindChild(m_widgetToFullName["PackageEquipInfo"]).gameObject.SetActive(show);
    ...
    {
        m_myTransform.FindChild(m_widgetToFullName["PackageEquipCurrentInfo"]).gameObject.SetActive(show);

        if (show)
        {
            m_equipDetailLblEquip.text = LanguageData.GetContent(47281); // 替换
            m_myTransform.FindChild(m_widgetToFullName["PacakgeEquipNewInfo"]).localPosition =
                m_myTransform.FindChild(m_widgetToFullName["PackageEquipNewInfoPos"]).localPosition;
        }
        else
        {
            m_equipDetailLblEquip.text = LanguageData.GetContent(47282); // 装备
            m_myTransform.FindChild(m_widgetToFullName["PacakgeEquipNewInfo"]).localPosition = Vector3.zero;
        }
    }
    ...
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["BeltFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
    ...
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["BreastPlateFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.atlas = MogoUIManager.Instance.GetAtlasByIconName(imgName);
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["BreastPlateFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerCuishFG(string imgName, int color = 0)
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["CuishFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.atlas = MogoUIManager.Instance.GetAtlasByIconName(imgName);
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["CuishFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerHandGuardFG(string imgName, int color = 0)
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["HandGuardFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.atlas = MogoUIManager.Instance.GetAtlasByIconName(imgName);
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["HandGuardFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerHeadEquipFG(string imgName, int color = 0)
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["HeadEquipFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.atlas = MogoUIManager.Instance.GetAtlasByIconName(imgName);
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["HeadEquipFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerNecklaceFG(string imgName, int color = 0)
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["NecklaceFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.atlas = MogoUIManager.Instance.GetAtlasByIconName(imgName);
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["NecklaceFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerWingFG(string imgName, int color = 0)
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["WingFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.atlas = MogoUIManager.Instance.GetAtlasByIconName(imgName);
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(temp, color);
    }
    ...
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["RingLeftFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.atlas = MogoUIManager.Instance.GetAtlasByIconName(imgName);
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["RingLeftFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerRingRightFG(string imgName, int color = 0)
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["RingRightFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.atlas = MogoUIManager.Instance.GetAtlasByIconName(imgName);
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["RingRightFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerShoesFG(string imgName, int color = 0)
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["ShoesFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.atlas = MogoUIManager.Instance.GetAtlasByIconName(imgName);
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["ShoesFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerShoudersFG(string imgName, int color = 0)
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["ShoudersFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.atlas = MogoUIManager.Instance.GetAtlasByIconName(imgName);
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["ShoudersFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerWeaponFG(string imgName, int color = 0)
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["WeaponFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.atlas = MogoUIManager.Instance.GetAtlasByIconName(imgName);
        Mogo.Util.LoggerHelper.Debug(temp.atlas + " " + imgName);
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["WeaponFG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerBeltBG(string imgName, int color = 0)
    {
        UISlicedSprite temp = m_myTransform.FindChild(m_widgetToFullName["BeltBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0];
        temp.spriteName = imgName;
        MogoUtils.SetImageColor(temp, color);
    ...
    {
        m_myTransform.FindChild(m_widgetToFullName["BreastPlateBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0].spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["BreastPlateBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerCuishBG(string imgName, int color = 0)
    {
        m_myTransform.FindChild(m_widgetToFullName["CuishBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0].spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["CuishBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerHandGuardBG(string imgName, int color = 0)
    {
        m_myTransform.FindChild(m_widgetToFullName["HandGuardBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0].spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["HandGuardBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerHeadEquipBG(string imgName, int color = 0)
    {
        m_myTransform.FindChild(m_widgetToFullName["HeadEquipBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0].spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["HeadEquipBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerNecklaceBG(string imgName, int color = 0)
    {
        m_myTransform.FindChild(m_widgetToFullName["NecklaceBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0].spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["NecklaceBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerWingBG(string imgName, int color = 0)
    {
        m_myTransform.FindChild(m_widgetToFullName["WingBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0].spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["WingBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerRingLeftBG(string imgName, int color = 0)
    {
        m_myTransform.FindChild(m_widgetToFullName["RingLeftBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0].spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["RingLeftBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerRingRightBG(string imgName, int color = 0)
    {
        m_myTransform.FindChild(m_widgetToFullName["RingRightBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0].spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["RingRightBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerShoesBG(string imgName, int color = 0)
    {
        m_myTransform.FindChild(m_widgetToFullName["ShoesBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0].spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["ShoesBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerShoudersBG(string imgName, int color = 0)
    {
        m_myTransform.FindChild(m_widgetToFullName["ShoudersBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0].spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["ShoudersBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }

    public void SetPlayerWeaponBG(string imgName, int color = 0)
    {
        m_myTransform.FindChild(m_widgetToFullName["WeaponBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0].spriteName = imgName;
        MogoUtils.SetImageColor(m_myTransform.FindChild(m_widgetToFullName["WeaponBG"]).GetComponentsInChildren<UISlicedSprite>(true)[0], color);
    }
         ...
         (List<string> attrs, List<string> jewels, string level, string vocation)
    {
        ...
        Transform root = m_myTransform.FindChild(m_widgetToFullName["PackageEquipCurrentInfoList"]);
        //加载+排版
        ...
        //需求等级等
        Transform detail3 = m_myTransform.FindChild(m_widgetToFullName["PackageEquipCurrentInfoDetail3"]);
        detail3.localPosition = new Vector3(detail3.localPosition.x, gap, detail3.localPosition.z);
    ...
    void Initialize()
    {
        ...
        m_myTransform.FindChild(m_widgetToFullName["EquipFXRefreshBtn"]).GetComponentsInChildren<MFUIButtonHandler>(true)[0].ClickHandler = OnEquipFXRefreshBtnUp;
    }
    ...
    {
        m_myTransform.FindChild(m_widgetToFullName["PlayerDetailAttribute"]).gameObject.SetActive(true);
        ShowBasicAttr();
        m_myTransform.FindChild(m_widgetToFullName["EquipModelImage"]).gameObject.SetActive(false);
    }
    ...
    {
        m_myTransform.FindChild(m_widgetToFullName["PlayerDetailAttribute"]).gameObject.SetActive(false);
        m_myTransform.FindChild(m_widgetToFullName["EquipModelImage"]).gameObject.SetActive(true);
    }
        ...
        float fLookatOffsetX = 0f)
    {
        ...
        Vector3 pos = obj.transform.FindChild("slot_camera").position;
    ...
    public void FakeNormalPackage(int page = 0)
    {
        ...
        m_myTransform.FindChild(m_widgetToFullName["NormalIcon"]).GetComponentsInChildren<MogoFakeClick>(true)[0].FakeIt();
    ...
    public void FakeGemPackage(int page = 0)
    {
        ...
        m_myTransform.FindChild(m_widgetToFullName["GemIcon"]).GetComponentsInChildren<MogoFakeClick>(true)[0].FakeIt();
        MoveToPackagePage(page, true);
        //SetCurrentPage(page, true);
    }
    ...
    public void FakeMaterialPackage(int page = 0)
    {
        ...
        m_myTransform.FindChild(m_widgetToFullName["MaterialIcon"]).GetComponentsInChildren<MogoFakeClick>(true)[0].FakeIt();
        MoveToPackagePage(page, true);
        //SetCurrentPage(page, true);
    }
    ...
    public void AddPacakgeItemGrid(UIAtlas atlas)
    {
        AssetCacheMgr.GetUIInstance("PackageItemGrid.prefab", (prefab, guid, go) =>
        {
            ...
            obj.transform.FindChild("PackageItemGridUp").GetComponentsInChildren<PackageItemBoxUpSign>(true)[0].id = m_listGridUp.Count;
            obj.GetComponentsInChildren<MyDragCamera>(true)[0].RelatedCamera = m_myTransform.FindChild(m_widgetToFullName["PackageCamera"]).GetComponentsInChildren<Camera>(true)[0];

            obj.transform.FindChild("PackageItemGridFG").GetComponentsInChildren<UISlicedSprite>(true)[0].atlas = atlas;
            obj.transform.FindChild("PackageItemGridFGFG").GetComponentsInChildren<UISlicedSprite>(true)[0].atlas = atlas;

            m_lisgGridGO.Add(obj);
            m_listGridUp.Add(obj.transform.FindChild("PackageItemGridUp").GetComponentsInChildren<UISlicedSprite>(true)[0]);
            UISprite tempGridUpBl = obj.transform.FindChild("PackageItemGridUp2").GetComponentsInChildren<UISprite>(true)[0];
            tempGridUpBl.gameObject.SetActive(false);
            m_listGridUpBl.Add(tempGridUpBl);
            m_listGridNum.Add(obj.transform.FindChild("PackageItemGridNum").GetComponentsInChildren<UILabel>(true)[0]);
            m_listGridFG.Add(obj.transform.FindChild("PackageItemGridFG").GetComponentsInChildren<UISlicedSprite>(true)[0]);
            obj.transform.FindChild("PackageItemGridFG").GetComponentsInChildren<UISlicedSprite>(true)[0].selfRefresh = false;
            m_listGridBG.Add(obj.transform.FindChild("PackageItemGridBG").GetComponentsInChildren<UISlicedSprite>(true)[0]);
    ...
    {
        m_myTransform.FindChild(m_widgetToFullName["GOPlayerEquipL"]).gameObject.SetActive(isShow);
        m_myTransform.FindChild(m_widgetToFullName["GOPlayerEquipM"]).gameObject.SetActive(isShow);
        m_myTransform.FindChild(m_widgetToFullName["GOPlayerEquipR"]).gameObject.SetActive(isShow);
    }

    public void ShowRefreshEquipFXBtn(bool isShow)
    {
        m_myTransform.FindChild(m_widgetToFullName["EquipFXRefreshBtn"]).gameObject.SetActive(isShow);
    }

    public void ShowIconListMask(bool isShow)
    {
        m_myTransform.FindChild(m_widgetToFullName["IconListBGMask"]).gameObject.SetActive(isShow);
    }
}