...
public class OperatingUIViewManager : MogoUIBehaviour 
{
    ...
    private UISprite m_spOperatingUIRefreshCtrl; // 用于刷新MogoUI图集
    ...
    void Initialize()
    {
        ...
        m_myTransform.FindChild(m_widgetToFullName["AttributeRewardBtn"]).GetComponentsInChildren<MogoButton>(true)[0].clickHandler += OnAttributeRewardBtnUp;
        m_myTransform.FindChild(m_widgetToFullName["ChargeRewardBtn"]).GetComponentsInChildren<MogoButton>(true)[0].clickHandler += OnChargeRewardBtnUp;
        m_myTransform.FindChild(m_widgetToFullName["LoginRewardBtn"]).GetComponentsInChildren<MogoButton>(true)[0].clickHandler += OnLoginRewardBtnUp;
        m_myTransform.FindChild(m_widgetToFullName["TimeLimitActivityBtn"]).GetComponentsInChildren<MogoButton>(true)[0].clickHandler += OnTimeLimitActivityBtnUp;
        m_myTransform.FindChild(m_widgetToFullName["OperatingUICloseBtn"]).GetComponentsInChildren<MogoButton>(true)[0].clickHandler += OnCloseBtnUp;
    }
