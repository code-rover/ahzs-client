...
public class ArenaUIViewManager : MogoParentUI
{
    ...
    void Awake()
    {
        ...
        m_head = m_transform.FindChild("leftPanel/imgHead").gameObject;
        m_name = m_transform.FindChild("leftPanel/lblName").gameObject;
        m_title = m_transform.FindChild("leftPanel/lblTitle").gameObject;
        m_progress = m_transform.FindChild("leftPanel/GameObject/ProgressBar").gameObject;        
        m_nextTitle = m_transform.FindChild("leftPanel/GameObject/lblNextTitle").gameObject;
        m_battleForce = m_transform.FindChild("leftPanel/lblForce").gameObject;
        m_dayPoint = m_transform.FindChild("leftPanel/lblDay").gameObject;
        m_weekPoint = m_transform.FindChild("leftPanel/lblWeek").gameObject;
        m_arenaCD = m_transform.FindChild("leftPanel/btnClearCD").gameObject;
        m_lblArenaCDNum = m_transform.FindChild("leftPanel/btnClearCD/BtnClearCDNum").GetComponentsInChildren<UILabel>(true)[0];
        m_arenaTimes = m_transform.FindChild("leftPanel/btnAddTimes/text").gameObject;
        m_revengeBtn = m_transform.FindChild("EnemyList/Revenge").gameObject;
        m_buttonList[3] = m_revengeBtn.AddComponent<ArenaButton>();
        m_strongBtn = m_transform.FindChild("EnemyList/Strong").gameObject;
        m_buttonList[2] = m_strongBtn.AddComponent<ArenaButton>();
        m_weakBtn = m_transform.FindChild("EnemyList/Weak").gameObject;
        m_refreshBtn = m_transform.FindChild("btnRefresh").gameObject;
        m_revengeBuffBtn = m_transform.FindChild("btnRevenge").gameObject;
        m_goArenaUIBtnEnter = m_transform.FindChild("ArenaUIBtnEnter").gameObject;
        m_goGOModelSuccesFlag = m_transform.FindChild("GOModelSuccesFlag").gameObject;
        ...
        foreach (var item in m_buttonList)
        {
            ...
            item.Value.transform.FindChild("RewardText").GetComponent<UILabel>().text = LanguageData.dataMap.Get(25034).Format(data.win[12], data.win[11]);
        }
        ...
        m_modelShowCase = m_transform.FindChild("ModelShowCase").gameObject;
        var sc = m_modelShowCase.AddComponent<ModelShowCase>();
        sc.left = m_transform.FindChild("Model/left");
        sc.right = m_transform.FindChild("Model/right");
        //sc.LoadCreateCharacter();
        m_lblPlayerDescTitle = m_transform.FindChild("player/PlayerDescTitle").GetComponentsInChildren<UILabel>(true)[0];
        m_lblPlayerDescRange = m_transform.FindChild("player/PlayerDescRange").GetComponentsInChildren<UILabel>(true)[0];
        m_playerForce = m_transform.FindChild("player/playerForce").gameObject;
        m_playerLevel = m_transform.FindChild("player/playerLevel").gameObject;
        m_playerName = m_transform.FindChild("player/playerName").gameObject;
        m_playerVocation = m_transform.FindChild("player/playerVocation").gameObject;
        m_playerMedalIcon = m_transform.FindChild("player/MedalGO/MedalIcon").gameObject;
        m_playerMedalTitle = m_transform.FindChild("player/MedalGO/MedalTitle").gameObject;

        m_goGOArenaUIUseOKCancel = m_transform.FindChild("GOArenaUIUseOKCancel").gameObject;
        m_lblArenaUIUseInfoDiamondNum = m_transform.FindChild("GOArenaUIUseOKCancel/GOArenaUIUseInfo/ArenaUIUseInfoDiamondNum").GetComponentsInChildren<UILabel>(true)[0];
        m_goArenaUIUseTipEnableBGDown = m_transform.FindChild("GOArenaUIUseOKCancel/GOArenaUIUseTipEnable/ArenaUIUseTipEnable/ArenaUIUseTipEnableBGDown").gameObject;
        IsShowArenaRevengeTipDialog = SystemConfig.Instance.IsShowArenaRevengeTipDialog;

        m_goGOArenaUIPVPLevelTip = m_transform.FindChild("GOArenaUIPVPLevelTip").gameObject;
        m_lblArenaUIPVPLevelTipInfoCurTitle = m_transform.FindChild("GOArenaUIPVPLevelTip/GOArenaUIPVPLevelTipInfo/ArenaUIPVPLevelTipInfoCurTitle").GetComponentsInChildren<UILabel>(true)[0];
        m_lblArenaUIPVPLevelTipInfoCurPVPNum1 = m_transform.FindChild("GOArenaUIPVPLevelTip/GOArenaUIPVPLevelTipInfo/ArenaUIPVPLevelTipInfoCurPVPNum1").GetComponentsInChildren<UILabel>(true)[0];
        m_lblArenaUIPVPLevelTipInfoCurPVPNum2 = m_transform.FindChild("GOArenaUIPVPLevelTip/GOArenaUIPVPLevelTipInfo/ArenaUIPVPLevelTipInfoCurPVPNum2").GetComponentsInChildren<UILabel>(true)[0];
        m_lblArenaUIPVPLevelTipInfoNextTitle = m_transform.FindChild("GOArenaUIPVPLevelTip/GOArenaUIPVPLevelTipInfo/ArenaUIPVPLevelTipInfoNextTitle").GetComponentsInChildren<UILabel>(true)[0];
        m_lblArenaUIPVPLevelTipInfoNextPVPNum1 = m_transform.FindChild("GOArenaUIPVPLevelTip/GOArenaUIPVPLevelTipInfo/ArenaUIPVPLevelTipInfoNextPVPNum1").GetComponentsInChildren<UILabel>(true)[0];
        m_lblArenaUIPVPLevelTipInfoNextPVPNum2 = m_transform.FindChild("GOArenaUIPVPLevelTip/GOArenaUIPVPLevelTipInfo/ArenaUIPVPLevelTipInfoNextPVPNum2").GetComponentsInChildren<UILabel>(true)[0];

        m_lblArenaUIGoldNum = m_transform.FindChild("leftPanel/GOArenaUIGold/ArenaUIGoldNum").GetComponentsInChildren<UILabel>(true)[0];
        m_lblArenaUIDiamondNum = m_transform.FindChild("leftPanel/GOArenaUIDiamond/ArenaUIDiamondNum").GetComponentsInChildren<UILabel>(true)[0];

        m_goGOBtnRewardNotice = m_transform.FindChild("leftPanel/GOBtnRewardNotice").gameObject;

        // ChineseData
        m_transform.FindChild("leftPanel/GameObject/lblCurTitle").GetComponentsInChildren<UILabel>(true)[0].text
    ...
    public void HandleTabChange(int fromPage, int toPage)
    {
        ...
        m_buttonList[fromPage].transform.FindChild("RewardText").GetComponent<UILabel>().color = new Color32(143, 143, 143, 255);
        m_buttonList[fromPage].transform.FindChild("EnemyTypeText").GetComponent<UILabel>().color = new Color32(102, 85, 72, 255);
        m_buttonList[toPage].transform.FindChild("RewardText").GetComponent<UILabel>().color = new Color32(255, 255, 255, 255);
        m_buttonList[toPage].transform.FindChild("EnemyTypeText").GetComponent<UILabel>().color = new Color32(126, 49, 0, 255);
    }
    ...
    {
        m_revengeBuffBtn.transform.FindChild("buff").GetComponentsInChildren<UILabel>(true)[0].text = atk.ToString() + hp.ToString();
    }
    ...
    public void SetRefreshPrice(int price, int level)
    {
        if (level != 3)
        {
            m_refreshBtn.transform.FindChild("num").GetComponentsInChildren<UILabel>(true)[0].text = "X" + price.ToString();
        }
        else
        {
            m_revengeBuffBtn.transform.FindChild("num").GetComponentsInChildren<UILabel>(true)[0].text = "X" + price.ToString();
        }
    }
    ...
    /// <summary>
    /// 复仇仇敌被击败后角色模型上增加“已击败”同时隐藏 界面下方的“复仇鼓舞”和“挑战”按钮
    /// </summary>
