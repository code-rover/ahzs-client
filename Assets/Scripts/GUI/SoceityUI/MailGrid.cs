...
public class MailGrid : MonoBehaviour 
{
    ...
    void Awake()
    {
        ...
        m_lblMailGridName = m_myTransform.FindChild("MailGridName").GetComponentsInChildren<UILabel>(true)[0];
        m_lblMailGridTopic = m_myTransform.FindChild("MailGridTopic").GetComponentsInChildren<UILabel>(true)[0];
        m_lblMailGridTime = m_myTransform.FindChild("MailGridTime").GetComponentsInChildren<UILabel>(true)[0];
        m_spMailGridSignAttachNoRead = m_myTransform.FindChild("MailGridSign/MailGridSignAttachNoRead").GetComponentsInChildren<UISprite>(true)[0];
        m_spMailGridSignAttachRead = m_myTransform.FindChild("MailGridSign/MailGridSignAttachRead").GetComponentsInChildren<UISprite>(true)[0];
        m_spMailGridSignNoRead = m_myTransform.FindChild("MailGridSign/MailGridSignNoRead").GetComponentsInChildren<UISprite>(true)[0];
        m_spMailGridSignRead = m_myTransform.FindChild("MailGridSign/MailGridSignRead").GetComponentsInChildren<UISprite>(true)[0];
    }
