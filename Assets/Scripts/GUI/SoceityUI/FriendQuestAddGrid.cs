...
public class FriendQuestAddGrid : MonoBehaviour 
{
    ...
    void Awake()
    {
        ...
        m_spFriendHead = m_myTransform.FindChild("FriendHeadImg").GetComponentsInChildren<UISprite>(true)[0];
        ...
        m_lblText = m_myTransform.FindChild("AddFriendQuestText").GetComponentsInChildren<UILabel>(true)[0];
        m_goRegectButton = m_myTransform.FindChild("RegectButton").gameObject;
        m_goAcceptButton = m_myTransform.FindChild("AcceptButton").gameObject;
