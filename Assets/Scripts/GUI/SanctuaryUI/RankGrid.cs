...
public class RankGrid : MonoBehaviour
{
    ...
    void Awake()
    {
        m_lblAchieve = transform.FindChild("WeekRankDialogBodyGridAchieve").GetComponentsInChildren<UILabel>(true)[0];
        m_lblName = transform.FindChild("WeekRankDialogBodyGridName").GetComponentsInChildren<UILabel>(true)[0];
        m_lblRank = transform.FindChild("WeekRankDialogBodyGridRank").GetComponentsInChildren<UILabel>(true)[0];
    }
