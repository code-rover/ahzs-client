...
public class NewInstanceLevelGrid : MonoBehaviour {
	...
	public void MyStart()
	{
        m_goInstanceLevelLock = m_myTransform.FindChild(parentNameFlag + id + "Lock").gameObject;
        m_spInstanceLevelBGDown = m_myTransform.FindChild(parentNameFlag + id + "BGDown").GetComponent<UISprite>();
        m_spInstanceLevelBGUp = m_myTransform.FindChild(parentNameFlag + id + "BGUp").GetComponent<UISprite>();
	}
