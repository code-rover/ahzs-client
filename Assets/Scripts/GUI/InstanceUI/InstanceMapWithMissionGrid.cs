...
public class InstanceMapWithMissionGrid : MogoUIBehaviour 
{
    ...
    void Awake()
    {
        ...
        m_goLevelGridList = m_myTransform.FindChild(m_widgetToFullName["NewInstanceUIChooseLevelGridList"]).gameObject;
        m_goLevelPathList = m_myTransform.FindChild(m_widgetToFullName["NewInstanceUIChooseLevelPathList"]).gameObject;

        m_lblTitleName = m_myTransform.FindChild(m_widgetToFullName["NewInstanceUIChooseLevelTitleText"]).GetComponentsInChildren<UILabel>(true)[0];
        m_goInstanceMap = m_myTransform.FindChild(m_widgetToFullName["NewInstanceUIChooseLevelMapBG"]).gameObject;
