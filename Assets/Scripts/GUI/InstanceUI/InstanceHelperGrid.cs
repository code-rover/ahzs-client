...
public class InstanceHelperGrid : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        helperBG = helperTransform.FindChild("InstanceLevelChooseUIPlayerGridBG/InstanceLevelChooseUIPlayerGridBGUp").GetComponentsInChildren<UISprite>(true)[0];
        helperBGDown = helperTransform.FindChild("InstanceLevelChooseUIPlayerGridBG/InstanceLevelChooseUIPlayerGridBGDown").GetComponentsInChildren<UISprite>(true)[0];

        helperImage = helperTransform.FindChild("GOInstanceLevelChooseUIPlayerGridImage/InstanceLevelChooseUIPlayerGridImage").GetComponentsInChildren<UISprite>(true)[0];

        helperName = helperTransform.FindChild("InstanceLevelChooseUIPlayerGridName").GetComponentsInChildren<UILabel>(true)[0];
        helperLevel = helperTransform.FindChild("InstanceLevelChooseUIPlayerGridLevel").GetComponentsInChildren<UILabel>(true)[0];
        helperAttack = helperTransform.FindChild("InstanceLevelChooseUIPlayerGridAttack").GetComponentsInChildren<UILabel>(true)[0];
        helperHeartNumber = helperTransform.FindChild("InstanceLevelChooseUIPlayerGridHeartNumber").GetComponentsInChildren<UILabel>(true)[0];
    }
