...
public class NewInstanceGrid : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        m_spIconFG = m_myTransform.parent.FindChild("NewInstanceUIChooseLevelGridIcon/NewInstanceUIChooseLevelGridIconUp").GetComponentsInChildren<UISprite>(true)[0];
        m_spMark0 = m_myTransform.parent.FindChild("NewInstanceUIChooseLevelGridMarkList/NewInstanceUIChooseLevelGridMark0/NewInstanceUIChooseLevelGridMark0FG").GetComponentsInChildren<UISprite>(true)[0];
        m_spMark1 = m_myTransform.parent.FindChild("NewInstanceUIChooseLevelGridMarkList/NewInstanceUIChooseLevelGridMark1/NewInstanceUIChooseLevelGridMark1FG").GetComponentsInChildren<UISprite>(true)[0];

        m_goGridTip = m_myTransform.parent.FindChild("NewInstanceUIChooseLevelGridTip").gameObject;
        m_lblNewInstanceUIChooseLevelGridTipText = m_myTransform.parent.FindChild("NewInstanceUIChooseLevelGridTip/NewInstanceUIChooseLevelGridTipText").GetComponentsInChildren<UILabel>(true)[0];
    }
