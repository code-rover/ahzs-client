...
public class InstanceTaskRewardUIViewManager : MonoBehaviour
{
    ...
    public void SetRewardItemID(List<int> idList, List<int> countList)
    {
        for (int i = 0; i < 3; ++i)
        {
            ...
            {
                UISprite itemSprite = m_listInstaceRewardItem[i].transform.FindChild("InstanceTaskRewardItem" + i + "FG").GetComponentsInChildren<UISprite>(true)[0];
                UISprite bgSprite = m_listInstaceRewardItem[i].transform.FindChild("InstanceTaskRewardItem" + i + "BG").GetComponentsInChildren<UISprite>(true)[0];
                UILabel countLabel = m_listInstaceRewardItem[i].transform.FindChild("InstanceTaskRewardItem" + i + "Count").GetComponentsInChildren<UILabel>(true)[0];
    ...
    public void SetInstanceLevelRewardItemImage(List<string> imageNameList)
    {
        for (int i = 0; i < 3; ++i)
        {
            ...
            {
                m_listInstaceRewardItem[i].transform.FindChild("InstanceTaskRewardItem" + i + "FG").GetComponentsInChildren<UISprite>(true)[0].atlas = MogoUIManager.Instance.GetAtlasByIconName(imageNameList[i]);
                m_listInstaceRewardItem[i].transform.FindChild("InstanceTaskRewardItem" + i + "FG").GetComponentsInChildren<UISprite>(true)[0].spriteName = imageNameList[i];
                m_listInstaceRewardItem[i].SetActive(true);
            }
            else
            {
    ...
    public void SetInstanceLevelRewardItemCount(List<int> countList)
    {
        for (int i = 0; i < 3; ++i)
        {
            ...
            {              
                m_listInstaceRewardItem[i].transform.FindChild("InstanceTaskRewardItem" + i + "Count").GetComponentsInChildren<UILabel>(true)[0].text = countList[i].ToString();
            }
            else
            {
            }
