...
public class NewChargeRewardUIViewManager : MFUIUnit
{
    ...
    public void AddChargePriceItem(List<string> itemText)
    {
        ...
        for (int i = 0; i < itemText.Count; ++i)
        {
            ...
            AssetCacheMgr.GetUIInstance("NewChargeRewardUIProgressGrid.prefab", (name, id, obj) =>
            {
                ...
                itemGo.transform.FindChild("NewChargeRewardUIProgressGridBtn/NewChargeRewardUIProgressGridBtnText").GetComponentsInChildren<UILabel>(true)[0].text = itemText[index];

                itemGo.transform.FindChild("NewChargeRewardUIProgressGridBtn").GetComponentsInChildren<MFUIButtonHandler>(true)[0].ClickHandler = OnProgressGridUp;

                itemGo.transform.FindChild("NewChargeRewardUIProgressGridBtn").GetComponentsInChildren<MFUIButtonHandler>(true)[0].ID = index;
    ...
    {
        m_listPriceItem[id].transform.FindChild("NewChargeRewardUIProgressGridBtn/NewChargeRewardUIProgressGridBtnText").GetComponentsInChildren<UILabel>(true)[0].text = text;
    }

    public void ShowProgressGridIconHighLight(bool isHighLight, int id)
    {
        m_listPriceItem[id].transform.FindChild("NewChargeRewardUIProgressGridBtn/NewChargeRewardUIProgressGridBtnDown").gameObject.SetActive(isHighLight);
    }
}
