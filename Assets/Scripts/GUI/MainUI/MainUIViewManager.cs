...
public class MainUIViewManager : MogoUIBehaviour
{
    ...
    {
        m_fsPlayerAnger.fillAmount = 0.12f + 0.58f * anger; //0.12f对应fillamont 0 , 0.7f对应1
    }
    ...
    {
        m_myTransform.FindChild(m_widgetToFullName["AffectBG"]).GetComponentsInChildren<UISprite>(true)[0].atlas = MogoUIManager.Instance.GetSkillIconAtlas();
        m_myTransform.FindChild(m_widgetToFullName["AffectDown"]).GetComponentsInChildren<UISprite>(true)[0].atlas = MogoUIManager.Instance.GetSkillIconAtlas();
        m_myTransform.FindChild(m_widgetToFullName["AffectUp"]).GetComponentsInChildren<UISprite>(true)[0].atlas = MogoUIManager.Instance.GetSkillIconAtlas();
        m_myTransform.FindChild(m_widgetToFullName["AffectFG"]).GetComponentsInChildren<UISprite>(true)[0].atlas = MogoUIManager.Instance.GetSkillIconAtlas();
    ...
    {
        UISprite spCD = m_myTransform.FindChild(m_widgetToFullName["AffectCD"]).GetComponentsInChildren<UISprite>(true)[0];
    ...
    {
        m_myTransform.FindChild(m_widgetToFullName["SpecialBG"]).GetComponentsInChildren<UISprite>(true)[0].atlas = MogoUIManager.Instance.GetSkillIconAtlas();
        m_myTransform.FindChild(m_widgetToFullName["SpecialDown"]).GetComponentsInChildren<UISprite>(true)[0].atlas = MogoUIManager.Instance.GetSkillIconAtlas();
        m_myTransform.FindChild(m_widgetToFullName["SpecialUp"]).GetComponentsInChildren<UISprite>(true)[0].atlas = MogoUIManager.Instance.GetSkillIconAtlas();
        m_myTransform.FindChild(m_widgetToFullName["SpecialFG"]).GetComponentsInChildren<UISprite>(true)[0].atlas = MogoUIManager.Instance.GetSkillIconAtlas();
    ...
    private UIFilledSprite[] m_fsBossTargetBloodList = new UIFilledSprite[5]; // 大Boss血条
    private UIFilledSprite[] m_fsSmallBossTargetBloodList = new UIFilledSprite[5]; // 小Boss血条
    ...
    {
        var go = m_myTransform.FindChild(m_widgetToFullName["NormalTarget"]).gameObject;
        if (go == null)
            return;
    ...
    public void ShowBossTarget(bool show, int level = 0, int type = (int)MonsterData.MonsterType.bigBoss)
    {
        ...
        GameObject goBoss = m_myTransform.FindChild(m_widgetToFullName["BossTarget"]).gameObject;
        GameObject goSmallBoss = m_myTransform.FindChild(m_widgetToFullName["SmallBossTarget"]).gameObject;
    ...
    {
        GameObject go = m_myTransform.FindChild(m_widgetToFullName["TaskInfo"]).gameObject;
        if (go.activeSelf)
        {
            go.SetActive(false);
        }
    ...
    private GameObject m_goMainUIPlayerExpList;// 角色经验条
    ...
    public void SetHpBottleVisible(bool show)
    {
        ...
        m_myTransform.FindChild(m_widgetToFullName["MainUIItem1"]).gameObject.SetActive(show);
    }
    public bool IsHpBottleVisible()
    {
        return m_myTransform.FindChild(m_widgetToFullName["MainUIItem1"]).gameObject.activeSelf;
    }
    ...
    {
        m_myTransform.FindChild(m_widgetToFullName["ProtectDiamondTip"]).gameObject.SetActive(isShow);
    }

    public void ShowAttackOgreTip(bool isShow)
    {
        m_myTransform.FindChild(m_widgetToFullName["AttackOgreTip"]).gameObject.SetActive(isShow);
    }
    ...
    public void SetAttackOgreTipIcon(string imgName)
    {
        ...
        m_myTransform.FindChild(m_widgetToFullName["AttackOgreTipIcon"]).GetComponentsInChildren<UISprite>(true)[0].spriteName = imgName;
    }
    ...
    public void SetProtectDiamondTipIcon(string imgName)
    {
        ...
        m_myTransform.FindChild(m_widgetToFullName["ProtectDiamondTipIcon"]).GetComponentsInChildren<UISprite>(true)[0].spriteName = imgName;
    }

    public void SetAttackOgreTipText(string text)
    {
        m_myTransform.FindChild(m_widgetToFullName["AttackOgreTipText"]).GetComponentsInChildren<UILabel>(true)[0].text = text;
    }

    public void SetProtectDiamondTipText(string text)
    {
        m_myTransform.FindChild(m_widgetToFullName["ProtectDiamondTipText"]).GetComponentsInChildren<UILabel>(true)[0].text = text;
    }
    ...
    public void AddShortCutCommunityGrid(List<string> shortcutText)
    {
        ...
        for (int i = 0; i < shortcutText.Count; ++i)
        {
            ...
            AssetCacheMgr.GetUIInstance("ShortCutGrid.prefab", (name, id, go) =>
            {
                ...
                gameObj.transform.FindChild("ShortCutGridText").GetComponentsInChildren<UILabel>(true)[0].text = shortcutText[index];
